...
cmd_iwlist_wlan1_scan       = 'iwlist wlan1 scan'
...
def wpa_supplicant_start():
    ...
    get_stdout(["./wpa_supplicant", "-i", "wlan1", "-c", "./wpa_0_8.conf", "-B"])
    time.sleep(1)
...
def p2p_enable():
    ...
    #print 'p2p_get role...'
    #get_stdout('iwpriv wlan1 p2p_get role')

    #print 'scan...'
    #get_stdout('iwlist wlan1 scan')
